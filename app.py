...
def results():
    ...
    return render_template('home.html', test_string=test_string, regex_pattern=regex_pattern, matches=matches, num_matches=num_matches, digit_or_string_count=digit_or_string_count, explanation=explanation)
